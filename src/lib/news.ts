...
const KEYWORDS_RU = [
  'связь', 'телеком', 'сеть', 'инфраструктура', 'кабель', 'спутник', 'блокчейн', 'офлайн',
  'транзакц', '5g', '4g', 'mesh', 'starlink', 'интернет', 'цифров', 'беларус', 'цифровой рубль',
  'радиосвязь', 'оптоволокн', 'беспроводн', 'широкополосн',
];
const KEYWORDS_EN = [
  'network', 'telecom', 'satellite', 'blockchain', 'offline', 'mesh', '5g', 'starlink',
  'infrastructure', 'cable', 'internet', 'transaction', 'connectivity', 'wireless', 'fiber',
  'broadband', 'digital currency', 'decentralized',
];
